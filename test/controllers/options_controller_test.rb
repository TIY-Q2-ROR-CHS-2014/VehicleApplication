...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { cost: @option.cost, markup: @option.markup, name: @option.name, option_type: @option.option_type }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { cost: @option.cost, markup: @option.markup, name: @option.name, option_type: @option.option_type }
    assert_redirected_to option_path(assigns(:option))
  end
